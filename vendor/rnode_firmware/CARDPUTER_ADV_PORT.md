...
KISS protocol. BLE is compiled in; holding Enter/OK for three seconds enters the
pairing flow used by other RNode boards, and pairing mode times out after 30
seconds if no client connects.
